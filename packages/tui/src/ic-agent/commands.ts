...
export function icCommandSpecs(model: IcTuiViewModel, options?: { debugView?: boolean }): IcCommandSpec[] {
  ...
  const commands: IcCommandSpec[] = [
    ...
    },
    {
      ...
      title: "Switch Motryx orchestrator",
      description: "Choose a project-scoped Motryx orchestrator conversation. Coordinator and checker sessions stay in debug view.",
      slashName: "orchestrators",
      slashAliases: ["sessions", "resume", "history"],
      category: "Motryx",
      enabled: true,
